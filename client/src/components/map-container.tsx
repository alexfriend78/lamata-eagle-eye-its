...
export default function MapContainer({ buses, routes, stations, selectedRoutes, theme, selectedZone, onZoneSelect, showMap, showStationNames, onStationClick, onStationHover, onBusHover, showLiveFeed }: MapContainerProps) {
  const getRoutePoints = (routeId: number) => {
    ...
    const routePaths: Record<number, { x: number; y: number }[]> = {
      ...
      5: [ // Purple Line - Southern express corridor (redesigned)
        { x: 100, y: 1500 }, { x: 500, y: 1480 }, { x: 900, y: 1460 }, { x: 1300, y: 1450 }, { x: 1700, y: 1460 }, 
        { x: 2100, y: 1470 }, { x: 2500, y: 1480 }, { x: 2900, y: 1490 }, { x: 3300, y: 1500 }
      ],
      ...
      11: [ // Lime Line - Rectangular loop (redesigned)
        { x: 400, y: 400 }, { x: 1000, y: 400 }, { x: 1600, y: 400 }, { x: 2200, y: 400 }, { x: 2800, y: 400 }, 
        { x: 2800, y: 800 }, { x: 2800, y: 1200 }, { x: 2200, y: 1200 }, { x: 1600, y: 1200 }, 
        { x: 1000, y: 1200 }, { x: 400, y: 1200 }, { x: 400, y: 800 }
      ],
      ...
      13: [ // Violet Line - S-curve pattern (redesigned)
        { x: 200, y: 300 }, { x: 600, y: 350 }, { x: 1000, y: 450 }, { x: 1400, y: 600 }, { x: 1800, y: 750 },
        { x: 2200, y: 900 }, { x: 2600, y: 1050 }, { x: 3000, y: 1200 }, { x: 2800, y: 1350 },
        { x: 2400, y: 1450 }, { x: 2000, y: 1500 }, { x: 1600, y: 1450 }, { x: 1200, y: 1350 },
        { x: 800, y: 1200 }, { x: 400, y: 1000 }, { x: 200, y: 750 }
      ],
      ...
      16: [ // Coral Line - Zigzag pattern (redesigned)
        { x: 150, y: 1800 }, { x: 500, y: 1850 }, { x: 850, y: 1800 }, { x: 1200, y: 1850 }, { x: 1550, y: 1800 }, 
        { x: 1900, y: 1850 }, { x: 2250, y: 1800 }, { x: 2600, y: 1850 }, { x: 2950, y: 1800 }, { x: 3300, y: 1850 }
      ]
    };
